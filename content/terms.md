...
**I make every effort to protect your data, but I am  not responsible nor liable for preserving your data, or knowing what kind of data existed before the servicing of any device.** I perform a bare metal imaging backup of your device a before a start a service. If something goes wrong with a servicing, I can use this backup to restore the computer to its original configuration. My backups are for internal use and done for safety reasons only.  
...
- Due to the anti-customer practices of Google and Microsoft. I now install Firefox with the Ublock Origin Adblocker Plug-in as the default browser. This is to protect my customers from user-hostile browser changes aimed at data collection and privacy invasive features. 
...
In many cases, storage device encryption prevents me from providing the services you request. For instance, if your system fails to boot, I will need to decrypt your storage device. There are other possible reasons for me to decrypt your file system, especially if I need to perform a bare metal backup of your system to protect the data contents in case of some kind of failure. For more information about that, see my "Protecting Your Data" section above. If your storage device has been encrypted by the default Windows installation, I will decrypt it using the credentials you supplied to me to provide the service. If you require your storage device to be encrypted, you can re-enable that encryption after the service is complete. Having a device with unencrypted storage may open your data up to theft, protecting your data is your responsibility. If you have questions about this topic or need help please, <a href="/#contact">Contact me</a> before requesting service. 
