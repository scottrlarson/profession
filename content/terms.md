...
**Due to a small percentage of bad experiences with certain hardware configurations, like failing electronics, I reserve the right to recommend a replacement part instead of a repair, if a replacement part exists, otherwise, Ill recommend a full replacement of the product. Please be prepared to cover the costs for the replacement device and my time for migrating your data. The costs usually run around $1,000, or more depending on what requirements you have.** 
